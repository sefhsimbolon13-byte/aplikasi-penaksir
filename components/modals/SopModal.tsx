  ...
  return (
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4 z-[80] transition-opacity">
      <div className="bg-white rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6 md:p-8 relative border border-slate-100">
        ...
        {/* Tambahan Apple Watch */}
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 hover:border-indigo-300 transition-colors">
              <h3 className="font-bold text-lg text-slate-800 flex items-center gap-2 mb-3">⌚ 4. Pengecekan Apple Watch</h3>
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-slate-600">
                <li><strong>Bodi & Layar:</strong> Cek mulus tidaknya bodi. Tes sentuh/swipe seluruh bagian layar.</li>
                <li><strong>Tombol:</strong> Pastikan <em>Digital Crown</em> bisa diputar dan tombol samping merespons normal.</li>
                <li><strong>Battery Health:</strong> Cek di Pengaturan &gt; Baterai &gt; Kesehatan Baterai (Pastikan &gt; 80%).</li>
                <li><strong>Unpair & Reset:</strong> Wajib lepas (<em>Unpair</em>) dari aplikasi Watch di iPhone pemilik. Masukkan sandi Apple ID hingga kereset.</li>
                <li><strong>Cek Nomor Seri:</strong> Cek nomor seri ke situs pengecekan iCloud (Pastikan status iCloud sudah OFF).</li>
                <li><strong>Kelengkapan:</strong> Samakan seri dengan kotak, tes charger memastikan daya terisi.</li>
                <li><strong className="text-rose-600">FATAL:</strong> Tidak bisa di-unpair / status iCloud belum OFF = <strong>TOLAK GADAI.</strong></li>
              </ul>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 hover:border-indigo-300 transition-colors">
              <h3 className="font-bold text-lg text-slate-800 flex items-center gap-2 mb-3">💻 3. Pengecekan Laptop / MacBook Lengkap</h3>
              
              <div className="space-y-4">
                {/* A. Fisik & Fungsi */}
                <div>
                  <p className="font-semibold text-slate-700 text-sm md:text-base border-b pb-1">A. Fisik & Fungsi</p>
                  <ul className="list-disc pl-5 space-y-1.5 text-sm md:text-base text-slate-600 mt-2">
                    <li><strong>Fisik & Engsel:</strong> Cek bodi, kelengkapan baut bawah, engsel, port charging, dan karet layar (tidak kelupas).</li>
                    <li><strong>Hardware Test:</strong> Kamera (Photo Booth), Speaker (YouTube), Keyboard (Web Keyboard Tester).</li>
                    <li><strong>Layar LCD:</strong> Cek pakai Dead Pixel Check (Putih, Hitam, Merah, Hijau, Biru) bebas shadow/jamur.</li>
                  </ul>
                </div>

                {/* B. Spesifikasi & Sistem */}
                <div>
                  <p className="font-semibold text-slate-700 text-sm md:text-base border-b pb-1">B. Spesifikasi & Sistem</p>
                  <ul className="list-disc pl-5 space-y-1.5 text-sm md:text-base text-slate-600 mt-2">
                    <li><strong>Cek Spek:</strong> Klik Logo Apple &gt; About This Mac &gt; More Info &gt; System Report.</li>
                    <li><strong>Baterai & Storage:</strong> Cek di menu Power (Cycle Count) dan menu Storage (Kapasitas Drive).</li>
                    <li><strong>Verifikasi Serial Number (SN):</strong> Cek SN di situs iUnlocker / FreeiCloud dan samakan spesifikasinya.</li>
                  </ul>
                </div>

                {/* C. Keamanan & iCloud */}
                <div>
                  <p className="font-semibold text-slate-700 text-sm md:text-base border-b pb-1 text-orange-600">C. Keamanan & iCloud (Logout Manual)</p>
                  <ul className="list-disc pl-5 space-y-1.5 text-sm md:text-base text-slate-600 mt-2">
                    <li><strong>Matikan Fitur Lacak:</strong> Menu Apple ID &gt; iCloud &gt; Tampilkan Semua &gt; Matikan Lacak Mac (Masukkan Sandi iCloud).</li>
                    <li><strong>Matikan Layanan Lokasi:</strong> Privasi & Keamanan &gt; Layanan Lokasi OFF (Masukkan Sandi Login Mac).</li>
                    <li><strong>Verifikasi Web:</strong> Cek SN di IMEI24.com, pastikan status Find My Mac = OFF.</li>
                    <li><strong>Logout Akun:</strong> Masuk ke Apple ID &gt; Sign Out (Keluar) sampai bersih dari perangkat.</li>
                  </ul>
                </div>

                {/* D. Aturan Reset */}
                <div className="bg-rose-50 border border-rose-200 p-4 rounded-xl">
                  <p className="font-bold text-rose-700 text-sm md:text-base border-b border-rose-200 pb-1 flex items-center gap-2">
                    <span>⚠️</span> D. Aturan Reset (Sangat Penting)
                  </p>
                  <ul className="list-disc pl-5 space-y-1.5 text-sm md:text-base text-rose-800 mt-2 font-medium">
                    <li>
                      <strong>MacBook 2018 ke Atas:</strong> WAJIB di-reset atas izin nasabah.
                      <br /> <span className="font-normal text-rose-700 text-sm">Langkah: Buka Pengaturan &gt; Umum &gt; Transfer atau Atur Ulang &gt; Hapus Semua Konten dan Pengaturan. Masukkan sandi Mac & Apple ID. Setelah restart, wajib hubungkan ke Wi-Fi untuk pastikan tidak ada Activation Lock.</span>
                    </li>
                    <li>
                      <strong>MacBook &lt; 2018:</strong> Tidak perlu di-reset. Cukup pastikan langkah bagian C (Logout iCloud & Lacak) sudah sukses dilakukan.
                    </li>
                    <li>
                      <strong className="text-red-600 font-black">FATAL:</strong> Nasabah menolak berikan password, iCloud nyangkut, atau Lacak aktif = <strong>TOLAK GADAI.</strong>
                    </li>
                  </ul>
                </div>
              </div>
